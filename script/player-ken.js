...
Player.prototype.CreateKen = function(right, up, left, down, p1, p2, p3, k1, k2, k3)
{
    ...
    p1.AddFrame(player, "", "images/misc/ken/x-p1-1.png", 3, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.LIGHT, [{ state: HIT_FLAGS.NEAR, x: 110, y: 193 }, { state: HIT_FLAGS.FAR, x: 194, y: 193}], ATTACK_FLAGS.LIGHT);
    p1.EndBlock();
    ...
    throw1.AddFrame(player, "", "images/misc/ken/x-throw-0-0.png", 9, { Combat: COMBAT_FLAGS.ATTACK }, { Player: PLAYER_FLAGS.MOBILE }, 0, 0, 0, 0, null, 0, 0, ATTACK_FLAGS.THROW_START, [{ state: HIT_FLAGS.NEAR, x: 130, y: 145 }, { state: HIT_FLAGS.FAR, x: 170, y: 185}], ATTACK_FLAGS.NONE, 1);
    throw1.AddFrame(player, "", "images/misc/ken/x-throw-0-1.png", 8, MISC_FLAGS.NONE, MISC_FLAGS.NONE);
    for (var i = 0; i < 2; ++i)
    {
        throw1.AddRepeatingFrame(player, "", "images/misc/ken/x-throw-0-2.png", 5, MISC_FLAGS.NONE, MISC_FLAGS.NONE, throw1X);
        ...
        throw1.AddRepeatingFrame(player, "", "images/misc/ken/x-throw-0-3.png", 5, MISC_FLAGS.NONE, MISC_FLAGS.NONE, throw1X);
    }
    throw1.AddRepeatingFrame(player, "", "images/misc/ken/x-throw-0-4.png", 2, MISC_FLAGS.NONE, MISC_FLAGS.NONE, -2);
    throw1.AddFrame(player, "", "images/misc/ken/x-throw-0-5.png", 25, { Combat: COMBAT_FLAGS.ATTACK }, { Player: PLAYER_FLAGS.MOBILE }, -10, 0, 0, 100, null, 0, 0, ATTACK_FLAGS.THROW_EJECT, [{ x: -1, y: -1, Fx: 1, Fy: 1}], ATTACK_FLAGS.NONE, 2);
    ...
    p2.AddFrame(player, "", "images/misc/ken/x-p2-1.png", 2, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.MEDIUM, [{ state: HIT_FLAGS.NEAR, x: 130, y: 145 }, { state: HIT_FLAGS.FAR, x: 170, y: 185}], ATTACK_FLAGS.MEDIUM);
    p2.AddFrame(player, "", "images/misc/ken/x-p2-2.png", 5, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.MEDIUM, [{ state: HIT_FLAGS.NEAR, x: 150, y: 220 }, { state: HIT_FLAGS.FAR, x: 135, y: 270}], ATTACK_FLAGS.MEDIUM);
    p2.EndBlock();
    ...
    p3.AddFrame(player,"","images/misc/ken/x-p3-2.png",4,{Combat:COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.NEAR,x:130,y:181},{state:HIT_FLAGS.FAR,x:215,y:181}],ATTACK_FLAGS.HARD);
    p3.EndBlock();
    ...
    k1.AddFrame(player, "", "images/misc/ken/x-k1-2.png", 7, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 80, 0, ATTACK_FLAGS.LIGHT, [{ state: HIT_FLAGS.NEAR, x: 200, y: 135 }, { state: HIT_FLAGS.NEAR, x: 250, y: 85}], ATTACK_FLAGS.LIGHT);
    k1.EndBlock();
    k1.AddFrame(player, "", "images/misc/ken/x-k1-1.png", 2, MISC_FLAGS.NONE, MISC_FLAGS.NONE, 0, 0, 0, 0, 0, 60);
    ...
    k2.AddFrame(player, "", "images/misc/ken/x-k2-4.png", 2, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 70, 0, ATTACK_FLAGS.LIGHT, [{ state: HIT_FLAGS.NEAR, x: 195, y: 160 }, { state: HIT_FLAGS.NEAR, x: 215, y: 200}], ATTACK_FLAGS.LIGHT, 1);
    k2.AddFrame(player, "", "images/misc/ken/x-k2-5.png", 5, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 76, 0, ATTACK_FLAGS.HARD, [{ state: HIT_FLAGS.FAR, x: 205, y: 170 }, { state: HIT_FLAGS.FAR, x: 305, y: 225}], ATTACK_FLAGS.HARD | ATTACK_FLAGS.REAR | ATTACK_FLAGS.SPIT1, 2);
    k2.EndBlock();
    ...
    f_k2.AddFrame(player, "", "images/misc/ken/x-fk2-7.png", 3, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, 0, 76, 0, ATTACK_FLAGS.MEDIUM, [{ state: HIT_FLAGS.NEAR, x: 275, y: 250 }, { state: HIT_FLAGS.NEAR, x: 215, y: 200}], ATTACK_FLAGS.MEDIUM, CONSTANTS.FIRST_HIT);
    f_k2.AddFrame(player, "", "images/misc/ken/x-fk2-8.png", 3, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, 0, 76, 0, ATTACK_FLAGS.MEDIUM, [{ state: HIT_FLAGS.NEAR, x: 315, y: 160 }, { state: HIT_FLAGS.NEAR, x: 215, y: 200}], ATTACK_FLAGS.MEDIUM, CONSTANTS.SECOND_HIT);
    f_k2.EndBlock();
    ...
    k3.AddFrame(player, "", "images/misc/ken/x-k3-4.png", 3, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 56, 0, ATTACK_FLAGS.HARD, [{ state: HIT_FLAGS.NEAR, x: 165, y: 150 }, { state: HIT_FLAGS.NEAR, x: 220, y: 150 }, { state: HIT_FLAGS.NEAR, x: 305, y: 120}], ATTACK_FLAGS.HARD);
    k3.EndBlock();
    k3.AddFrame(player, "", "images/misc/ken/x-k3-5.png", 5, PLAYER_FLAGS.MOVE_TO_BACK, MISC_FLAGS.NONE, 0, 0, 0, 0, 0, 75);
    ...
    crouch_p1.AddFrame(player, "", "images/misc/ken/x-crouch-p1-2.png", 3, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.LIGHT | ATTACK_FLAGS.HITS_LOW, [{ state: HIT_FLAGS.NEAR, x: 110, y: 120 }, { state: HIT_FLAGS.NEAR, x: 194, y: 120}], ATTACK_FLAGS.LIGHT);
    crouch_p1.EndBlock();
    ...
    crouch_p2.AddFrame(player, "", "images/misc/ken/x-crouch-p2-3.png", 3, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.MEDIUM | ATTACK_FLAGS.HITS_LOW, [{ state: HIT_FLAGS.NEAR, x: 110, y: 120 }, { state: HIT_FLAGS.NEAR, x: 194, y: 120}], ATTACK_FLAGS.MEDIUM);
    crouch_p2.EndBlock();
    ...
    crouch_k1.AddFrame(player, "", "images/misc/ken/x-crouch-k1-2.png", 5, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.LIGHT | ATTACK_FLAGS.HITS_LOW, [{ state: HIT_FLAGS.NEAR, x: 110, y: 40 }, { state: HIT_FLAGS.NEAR, x: 210, y: 1}], ATTACK_FLAGS.LIGHT);
    crouch_k1.EndBlock();
    ...
    crouch_k2.AddFrame(player, "264", "images/misc/ken/x-crouch-k2-3.png", 5, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.MEDIUM | ATTACK_FLAGS.HITS_LOW, [{ state: HIT_FLAGS.NEAR, x: 140, y: 35 }, { state: HIT_FLAGS.NEAR, x: 185, y: 30 }, { state: HIT_FLAGS.NEAR, x: 260, y: 1}], ATTACK_FLAGS.MEDIUM);
    crouch_k2.EndBlock();
    ...
    crouch_k3.AddFrame(player, "", "images/misc/ken/x-crouch-k3-2.png", 5, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.HARD | ATTACK_FLAGS.HITS_LOW | ATTACK_FLAGS.TRIP, [{ state: HIT_FLAGS.NEAR, x: 160, y: 35 }, { state: HIT_FLAGS.FAR, x: 250, y: 35}], ATTACK_FLAGS.HARD);
    crouch_k3.EndBlock();
    ...
    for (var x = 0; x < 3; ++x)
    {
        ...
        var uppercut = player.AddAnimation(POSE_FLAGS.CROUCHING | POSE_FLAGS.STANDING | POSE_FLAGS.WALKING_FORWARD | POSE_FLAGS.WALKING_BACKWARD | POSE_FLAGS.ALLOW_INTERUPT, "uppercut p1", 200, [BUTTONS.FORWARD, 0, BUTTONS.CROUCH, BUTTONS.CROUCH | BUTTONS.FORWARD, BUTTONS.FORWARD | button], 999, true, true);
        ...
        if(x == 2)
        {
            ...
            uppercut.AddFrame(player, "", "images/misc/ken/x-uppercut-p1-3.png", 18, { Player: PLAYER_FLAGS.IGNORE_PROJECTILES, Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 25, null, 0, 0, ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD | ATTACK_FLAGS.KNOCKDOWN, [{ state: HIT_FLAGS.FAR, x: 130, y: 127 }, { state: HIT_FLAGS.FAR, x: 110, y: 227 }, { state: HIT_FLAGS.FAR, x: 100, y: 322}], ATTACK_FLAGS.MEDIUM | ATTACK_FLAGS.REAR | ATTACK_FLAGS.SPECIAL3, CONSTANTS.THRID_HIT, CONSTANTS.SINGLE, 10);
        }
        else if(x == 1)
        {
    ...
    jump.AddRepeatingFrame(player, "", "images/misc/ken/x-jump-1.png", 7, { Pose: POSE_FLAGS.AIRBORNE });
    ...
    jump_p1.AddFrame(player, "", "images/misc/ken/x-jump-p1-2.png", 24, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.HITS_HIGH | ATTACK_FLAGS.LIGHT, [{ state: HIT_FLAGS.NEAR, x: 160, y: 75, Fx : airKnockBackX, Fy : 0}], ATTACK_FLAGS.LIGHT);
    jump_p1.EndBlock();
    ...
    jump_p2.AddFrame(player, "", "images/misc/ken/x-jump-p2-2.png", 15, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.HITS_HIGH | ATTACK_FLAGS.MEDIUM, [{ state: HIT_FLAGS.NEAR, x: 180, y: 55, Fx : airKnockBackX, Fy : 0}], ATTACK_FLAGS.MEDIUM);
    jump_p2.EndBlock();
    ...
    jump_p3.AddFrame(player, "", "images/misc/ken/x-jump-p2-2.png", 6, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.HITS_HIGH | ATTACK_FLAGS.HARD, [{ state: HIT_FLAGS.NEAR, x: 180, y: 55, Fx : airKnockBackX, Fy : 0}], ATTACK_FLAGS.HARD);
    jump_p3.EndBlock();
    ...
    jump_k1.AddFrame(player, "", "images/misc/ken/x-jump-k1-2.png", 24, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.HITS_HIGH | ATTACK_FLAGS.LIGHT, [{ state: HIT_FLAGS.NEAR, x: 140, y: 235, Fx : airKnockBackX, Fy : 0 }, { state: HIT_FLAGS.NEAR, x: 90, y: 155, Fx : airKnockBackX, Fy : 0}], ATTACK_FLAGS.LIGHT);
    jump_k1.EndBlock();
    ...
    jump_k2.AddFrame(player, "", "images/misc/ken/x-jump-k1-2.png", 4, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.HITS_HIGH | ATTACK_FLAGS.MEDIUM, [{ state: HIT_FLAGS.NEAR, x: 140, y: 235, Fx : airKnockBackX, Fy : 0 }, { state: HIT_FLAGS.NEAR, x: 90, y: 155, Fx : airKnockBackX, Fy : 0}], ATTACK_FLAGS.MEDIUM);
    jump_k2.EndBlock();
    ...
    jump_k3.AddFrame(player, "", "images/misc/ken/x-jump-k3-4.png", 6, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.HITS_HIGH | ATTACK_FLAGS.HARD, [{ state: HIT_FLAGS.NEAR, x: 180, y: 135, Fx : airKnockBackX, Fy : 0 }, { state: HIT_FLAGS.NEAR, x: 80, y: 135, Fx : airKnockBackX, Fy : 0}], ATTACK_FLAGS.HARD);
    jump_k3.EndBlock();
    ...
    f_jump_k1.AddFrame(player, "", "images/misc/ken/x-f-jump-k1-3.png", 24, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.HITS_HIGH | ATTACK_FLAGS.LIGHT, [{ state: HIT_FLAGS.NEAR, x: 140, y: 15, Fx : airKnockBackX, Fy : 0 }, { state: HIT_FLAGS.NEAR, x: 100, y: 0, Fx : airKnockBackX, Fy : 0}], ATTACK_FLAGS.LIGHT);
    ...
    f_jump_k2.AddFrame(player, "", "images/misc/ken/x-f-jump-k2-4.png", 11, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.HITS_HIGH | ATTACK_FLAGS.MEDIUM, [{ state: HIT_FLAGS.NEAR, x: 230, y: 35, Fx : airKnockBackX, Fy : 0 }, { state: HIT_FLAGS.NEAR, x: 130, y: 15, Fx : airKnockBackX, Fy : 0 }, { state: HIT_FLAGS.NEAR, x: 30, y: 5, Fx : airKnockBackX, Fy : 0}], ATTACK_FLAGS.MEDIUM);
    f_jump_k2.EndBlock();
    ...
    f_jump_k3.AddFrame(player, "", "images/misc/ken/x-f-jump-k3-2.png", 6, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.HITS_HIGH | ATTACK_FLAGS.HARD, [{ state: HIT_FLAGS.NEAR, x: 230, y: 0, Fx : airKnockBackX, Fy : 0 }, { state: HIT_FLAGS.NEAR, x: 130, y: 20, Fx : airKnockBackX, Fy : 0}], ATTACK_FLAGS.HARD);
    f_jump_k3.EndBlock();
    ...
    for (var x = 0; x < 3; ++x)
    {
        ...
        var fireball = player.AddAnimation(POSE_FLAGS.STANDING | POSE_FLAGS.CROUCHING | POSE_FLAGS.WALKING_BACKWARD | POSE_FLAGS.WALKING_FORWARD | POSE_FLAGS.ALLOW_INTERUPT, "fireball p" + x, 50, [BUTTONS.CROUCH, BUTTONS.CROUCH | BUTTONS.FORWARD, BUTTONS.FORWARD, BUTTONS.FORWARD | button], 0, false);
    ...
    for (var x = 0; x < 3; ++x)
    {
        ...
        spinkick.AddFrame(player, "", "images/misc/ken/x-hk-0.png", 4, { Player: PLAYER_FLAGS.SMALLER_AABB, Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.AIRBORNE }, { Player: PLAYER_FLAGS.MOBILE }, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD, [{ state: HIT_FLAGS.FAR, x: 170, y: 177}], rearFlags, CONSTANTS.FIRST_HIT, 0.75);
        ...
        spinkick.AddFrame(player, "", "images/misc/ken/x-hk-3.png", nbFrames, { Pose:POSE_FLAGS.HOLD_AIRBORNE, Player: PLAYER_FLAGS.SMALLER_AABB, Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, baseDamage, null, 40, 0, ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD, [{ state: HIT_FLAGS.NEAR, x: 230, y: 97 }, { state: HIT_FLAGS.NEAR, x: 140, y: 97}, { state: HIT_FLAGS.NEAR, x: 230, y: 127 }, { state: HIT_FLAGS.NEAR, x: 140, y: 127}], rearFlags, CONSTANTS.SECOND_HIT, hitDelayFactor);
        ...
        spinkick.AddFrame(player, "", "images/misc/ken/x-hk-5.png", nbFrames, { Pose:POSE_FLAGS.HOLD_AIRBORNE, Player: PLAYER_FLAGS.SMALLER_AABB, Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, baseDamage, null, -60, 0, ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD, [{ state: HIT_FLAGS.NEAR, x: -60, y: 97 }, { state: HIT_FLAGS.NEAR, x: 30, y: 97}, { state: HIT_FLAGS.NEAR, x: -60, y: 127 }, { state: HIT_FLAGS.NEAR, x: 30, y: 127}], rearFlags, 3 * (i + 1), hitDelayFactor);
        ...
        for (var i = 0; i < (1 + x); ++i)
        {
            spinkick.AddFrame(player, "", "images/misc/ken/x-hk-3.png", nbFrames, { Pose:POSE_FLAGS.HOLD_AIRBORNE, Player: PLAYER_FLAGS.SMALLER_AABB, Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, baseDamage, null, 40, 0, ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD, [{ state: HIT_FLAGS.NEAR, x: 230, y: 97 }, { state: HIT_FLAGS.NEAR, x: 140, y: 97}, { state: HIT_FLAGS.NEAR, x: 230, y: 127 }, { state: HIT_FLAGS.NEAR, x: 140, y: 127}], rearFlags, 3 * (i + 1), hitDelayFactor);
            spinkick.AddFrame(player, "", "images/misc/ken/x-hk-4.png", nbFrames, { Pose:POSE_FLAGS.HOLD_AIRBORNE, Player: PLAYER_FLAGS.SMALLER_AABB });
            spinkick.AddFrame(player, "", "images/misc/ken/x-hk-5.png", nbFrames, { Pose:POSE_FLAGS.HOLD_AIRBORNE, Player: PLAYER_FLAGS.SMALLER_AABB, Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, baseDamage, null, -30, 0, ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD, [{ state: HIT_FLAGS.NEAR, x: -30, y: 97 }, { state: HIT_FLAGS.NEAR, x: 30, y: 97}, { state: HIT_FLAGS.NEAR, x: -30, y: 127 }, { state: HIT_FLAGS.NEAR, x: 30, y: 127}], rearFlags, 3 * (i + 1), hitDelayFactor);
            spinkick.AddFrame(player, "", "images/misc/ken/x-hk-6.png", nbFrames, { Pose:POSE_FLAGS.HOLD_AIRBORNE, Player: PLAYER_FLAGS.SMALLER_AABB }, 0, 0, 0, 0, 0, null, +40);
        }
    ...
    for (var x = 1; x < 4; ++x)
    {
        ...
        var roll = player.AddAnimation(POSE_FLAGS.STANDING | POSE_FLAGS.CROUCHING | POSE_FLAGS.WALKING_BACKWARD | POSE_FLAGS.WALKING_FORWARD | POSE_FLAGS.ALLOW_INTERUPT, "roll p" + x, 100, [BUTTONS.CROUCH, BUTTONS.CROUCH | BUTTONS.BACK, BUTTONS.BACK, BUTTONS.BACK | button], 0, false);
...
Player.prototype.CreateKenSuperMoves = function(player)
{
    ...
    for(var x = 0; x < 3; ++x)
    {
        ...
        var s_uppercut = player.AddAnimation(POSE_FLAGS.CROUCHING|POSE_FLAGS.STANDING|POSE_FLAGS.WALKING_FORWARD|POSE_FLAGS.WALKING_BACKWARD|POSE_FLAGS.ALLOW_INTERUPT,"s_uppercut p" + (x+1),300,[BUTTONS.CROUCH,BUTTONS.CROUCH|BUTTONS.FORWARD,BUTTONS.FORWARD,0,BUTTONS.CROUCH,BUTTONS.CROUCH|BUTTONS.FORWARD,BUTTONS.FORWARD,BUTTONS.FORWARD|button],999,true,true);
