...
Player.prototype.createSagat = function(user)
{
    ...
    getup.addFrameWithSound(player,1,"audio/misc/floored-1.zzz",0,"200",folder + "/hit-air-3.png",4,{Player:PLAYER_FLAGS.INVULNERABLE,Spawn:SPAWN_FLAGS.SPAWN_SMALLDIRT},{Player:PLAYER_FLAGS.MOBILE});
    getup.addFrame(player,0,"200",folder + "/down.png",3,{Player:PLAYER_FLAGS.INVULNERABLE});
    getup.addFrame(player,0,"",folder + "/getup-0.png",3,{Player:PLAYER_FLAGS.INVULNERABLE});
    getup.addFrame(player,0,"",folder + "/getup-1.png",3,{Player:PLAYER_FLAGS.INVULNERABLE});
    getup.addFrame(player,0,"",folder + "/getup-2.png",3,{Player:PLAYER_FLAGS.INVULNERABLE});
    getup.addFrame(player,0,"",folder + "/getup-3.png",3,{Player:PLAYER_FLAGS.INVULNERABLE});
    getup.addFrame(player,0,"",folder + "/getup-4.png",3,{Player:PLAYER_FLAGS.INVULNERABLE},0,0,0,0,0,0,0,66);
    getup.addFrame(player,0,"",folder + "/crouch-0.png",4,{Player:PLAYER_FLAGS.INVULNERABLE|PLAYER_FLAGS.MOBILE},0,0,0,0,0,0,0,0);
    ...
    getup_dizzy.addFrameWithSound(player,1,"audio/misc/floored-1.zzz",0,"200",folder + "/hit-air-3.png",4,{Player:PLAYER_FLAGS.INVULNERABLE,Spawn:SPAWN_FLAGS.SPAWN_SMALLDIRT},{Player:PLAYER_FLAGS.MOBILE});
    getup_dizzy.addFrame(player,0,"200",folder + "/down.png",3,{Player:PLAYER_FLAGS.INVULNERABLE});
    getup_dizzy.addFrame(player,0,"",folder + "/getup-0.png",3,{Player:PLAYER_FLAGS.INVULNERABLE});
    getup_dizzy.addFrame(player,0,"",folder + "/getup-1.png",3,{Player:PLAYER_FLAGS.INVULNERABLE});
    getup_dizzy.addFrame(player,0,"",folder + "/getup-2.png",3,{Player:PLAYER_FLAGS.INVULNERABLE});
    getup_dizzy.addFrame(player,0,"",folder + "/getup-3.png",3,{Player:PLAYER_FLAGS.INVULNERABLE});
    getup_dizzy.addFrame(player,0,"",folder + "/getup-4.png",3,{Player:PLAYER_FLAGS.INVULNERABLE},0,0,0,0,0,0,0,66);
    getup_dizzy.addFrame(player,0,"",folder + "/crouch-0.png",4,{Player:PLAYER_FLAGS.INVULNERABLE|PLAYER_FLAGS.MOBILE},0,0,0,0,0,0,0,0);
    ...
    hitReact_dizzyBounce.addFrameWithSound(player,1,"audio/misc/floored-2.zzz",0,"200",folder + "/hit-air-2.png",4,{Player:PLAYER_FLAGS.INVULNERABLE,Spawn:SPAWN_FLAGS.SPAWN_BIGDIRT},{Player:PLAYER_FLAGS.MOBILE},0,1);
    hitReact_dizzyBounce.addFrame(player,0,"200",folder + "/hit-air-3.png",CONSTANTS.FRAME_MAX,{Pose:POSE_FLAGS.AIRBORNE,Player:PLAYER_FLAGS.USE_ATTACK_DIRECTION|PLAYER_FLAGS.IGNORE_ATTACKS|PLAYER_FLAGS.INVULNERABLE},{Player: PLAYER_FLAGS.MOBILE});
    ...
    hitReact_dizzy.addFrame(player,0,"200",folder + "/hit-air-4.png",32,{ Player: PLAYER_FLAGS.INVULNERABLE | PLAYER_FLAGS.IGNORE_ATTACKS },{Player: PLAYER_FLAGS.MOBILE},1);
    ...
    hitReact_bounce.addFrameWithSound(player,1,"audio/misc/floored-2.zzz",0,"200",folder + "/hit-air-2.png",4,{Player:PLAYER_FLAGS.INVULNERABLE,Spawn:SPAWN_FLAGS.SPAWN_BIGDIRT},{Player:PLAYER_FLAGS.MOBILE},0,1);
    hitReact_bounce.addFrame(player,0,"200",folder + "/hit-air-3.png",CONSTANTS.FRAME_MAX,{Pose:POSE_FLAGS.AIRBORNE,Player:PLAYER_FLAGS.USE_ATTACK_DIRECTION|PLAYER_FLAGS.IGNORE_ATTACKS|PLAYER_FLAGS.INVULNERABLE},{Player: PLAYER_FLAGS.MOBILE});
    ...
    hitReact_deadBounce.addFrame(player,0,"200",folder + "/hit-air-3.png",CONSTANTS.FRAME_MAX,{Pose:POSE_FLAGS.AIRBORNE,Player:PLAYER_FLAGS.USE_ATTACK_DIRECTION|PLAYER_FLAGS.INVULNERABLE|PLAYER_FLAGS.IGNORE_ATTACKS|PLAYER_FLAGS.IGNORE_COLLISIONS},{Player:PLAYER_FLAGS.MOBILE});
    ...
    hitReact_eject.addFrame(player,0,"",folder + "/hit-air-5.png",CONSTANTS.FRAME_MAX,{Player:PLAYER_FLAGS.SUPER_INVULNERABLE});
    ...
    p1.addFrame(player,0,"",folder + "/p1-0.png",3,MISC_FLAGS.NONE,{ Player: PLAYER_FLAGS.MOBILE });
    p1.addFrame(player,0,"",folder + "/p1-1.png",3,{ SwingSound:SWINGSOUND.LP,Combat: COMBAT_FLAGS.ATTACK,Pose: POSE_FLAGS.ALLOW_INTERUPT_1,HitSound:HITSOUND.LP },MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.LIGHT,[{ state: HIT_FLAGS.LOW,x: 210,y: 243 },{ state: HIT_FLAGS.HIGH,x: 254,y: 213},{ state: HIT_FLAGS.HIGH,x: 194,y: 193}],ATTACK_FLAGS.LIGHT,1,0,10);
    p1.endBlock();
    p1.addFrame(player,0,"",folder + "/p1-2.png",3,MISC_FLAGS.NONE,MISC_FLAGS.NONE);
    ...
    p2.addFrame(player,0,"",folder + "/p2-1.png",2,{ SwingSound:SWINGSOUND.MP,Combat: COMBAT_FLAGS.ATTACK,Pose: POSE_FLAGS.ALLOW_INTERUPT_1,HitSound:HITSOUND.MP },MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.MEDIUM,[{ state: HIT_FLAGS.LOW,x: 240,y: 235 },{ state: HIT_FLAGS.HIGH,x: 170,y: 185}],ATTACK_FLAGS.MEDIUM,1,1,15);
    p2.addFrame(player,0,"",folder + "/p2-2.png",9,{ Combat: COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MP },MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.MEDIUM,[{ state: HIT_FLAGS.LOW,x: 210,y: 220 },{ state: HIT_FLAGS.HIGH,x: 215,y: 270},{ state: HIT_FLAGS.HIGH,x: 200,y: 370}],ATTACK_FLAGS.MEDIUM,1,1,15);
    p2.endBlock();
    p2.addFrame(player,0,"",folder + "/p2-3.png",5);
    ...
    k1.addFrame(player,0,"",folder + "/k1-2.png",1,MISC_FLAGS.NONE,MISC_FLAGS.NONE,0,0,0,0,0,50,9);
    k1.addFrame(player,0,"",folder + "/k1-3.png",7,{ SwingSound:SWINGSOUND.LP,Combat: COMBAT_FLAGS.ATTACK,Pose: POSE_FLAGS.ALLOW_INTERUPT_1,HitSound:HITSOUND.LK },MISC_FLAGS.NONE,0,0,0,10,null,50,15,ATTACK_FLAGS.LIGHT,[{ state: HIT_FLAGS.LOW,x: 200,y: 175 },{ state: HIT_FLAGS.LOW,x: 250,y: 155},{ state: HIT_FLAGS.LOW,x: 340,y: 95}],ATTACK_FLAGS.LIGHT,1,1,10);
    k1.endBlock();
    k1.addFrame(player,0,"",folder + "/k1-2.png",4,MISC_FLAGS.NONE,MISC_FLAGS.NONE,0,0,0,0,0,50,9);
    k1.addFrame(player,0,"",folder + "/k1-1.png",3,MISC_FLAGS.NONE,MISC_FLAGS.NONE,0,0,0,0,0,10,9);
    ...
    k3.addFrame(player,0,"",folder + "/k3-0.png",1,{SwingSound:SWINGSOUND.LP,Combat:COMBAT_FLAGS.ATTACK,Pose: POSE_FLAGS.ALLOW_INTERUPT_1,HitSound:HITSOUND.HK},MISC_FLAGS.NONE,0,0,0,10,null,96,9,ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.HIGH,x:180,y:175},{state:HIT_FLAGS.HIGH,x:240,y:235}],ATTACK_FLAGS.HARD,1,1,20);
    k3.addFrame(player,0,"",folder + "/k3-1.png",10,{Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.HK},MISC_FLAGS.NONE,0,0,0,10,null,66,9,ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.HIGH,x:220,y:205},{state:HIT_FLAGS.HIGH,x:250,y:245},{state:HIT_FLAGS.HIGH,x:350,y:233},{state:HIT_FLAGS.HIGH,x:300,y:305},{state:HIT_FLAGS.HIGH,x:370,y:285}],ATTACK_FLAGS.HARD,1,1,20);
    k3.endBlock();
    k3.addFrame(player,0,"",folder + "/k3-0.png",3,{Player:PLAYER_FLAGS.MOVE_TO_FRONT},MISC_FLAGS.NONE,0,0,0,0,0,96,9);
    ...
    for(var x = 0; x < 3; ++x)
    {
        ...
        tigerCrush.IgnoreDepressedKeys = true;
        ...
        tigerCrush.addFrame(player,0,"",folder + "/tigercrush-2.png",2,{Combat:COMBAT_FLAGS.ATTACK|COMBAT_FLAGS.STOP_SLIDE_BACK,HitSound:HITSOUND.HK},MISC_FLAGS.NONE,0,0,0,hit2Damage,null,0,100,ATTACK_FLAGS.SPECIAL|ATTACK_FLAGS.HARD|ATTACK_FLAGS.KNOCKDOWN,[{state:HIT_FLAGS.LOW,x:190,y:167,Fx:2.0},{state:HIT_FLAGS.LOW,x:210,y:177,Fx:2.0},{state:HIT_FLAGS.LOW,x:210,y:237,Fx:2.0},{state:HIT_FLAGS.LOW,x:150,y:257,Fx:2.0}],ATTACK_FLAGS.MEDIUM|ATTACK_FLAGS.REAR|ATTACK_FLAGS.SPECIAL2,CONSTANTS.SECOND_HIT,CONSTANTS.SINGLE,25);
        tigerCrush.addFrame(player,0,"",folder + "/tigercrush-2.png",3,{Combat:COMBAT_FLAGS.ATTACK|COMBAT_FLAGS.STOP_SLIDE_BACK,HitSound:HITSOUND.HK},MISC_FLAGS.NONE,0,0,0,hit2Damage,null,0,100,ATTACK_FLAGS.SPECIAL|ATTACK_FLAGS.HARD|ATTACK_FLAGS.KNOCKDOWN,[{state:HIT_FLAGS.LOW,x:190,y:167,Fx:2.0},{state:HIT_FLAGS.LOW,x:210,y:177,Fx:2.0},{state:HIT_FLAGS.LOW,x:210,y:237,Fx:2.0},{state:HIT_FLAGS.LOW,x:150,y:257,Fx:2.0}],ATTACK_FLAGS.MEDIUM|ATTACK_FLAGS.REAR|ATTACK_FLAGS.SPECIAL2,CONSTANTS.SECOND_HIT,CONSTANTS.SINGLE,25);
