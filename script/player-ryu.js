...
Player.prototype.CreateRyu = function(user)
{
    ...
    hitReact_sLN.AddFrame(player,0,"",folder + "/x-hit-sln-0.png",8,MISC_FLAGS.NONE,{Player:PLAYER_FLAGS.MOBILE});
    hitReact_sLN.AddFrameWithSound(player,1,"audio/ryu/clocked.zzz",0,"",folder + "/x-hit-smn-0.png",8);
    hitReact_sLN.AddFrame(player,0,"",folder + "/x-hit-sln-0.png",8);
    ...
    hitReact_sLF.AddFrame(player,0,"",folder + "/x-hit-slf-0.png",8,MISC_FLAGS.NONE,{Player:PLAYER_FLAGS.MOBILE});
    hitReact_sLF.AddFrame(player,0,"",folder + "/x-hit-smf-0.png",8);
    hitReact_sLF.AddFrame(player,0,"",folder + "/x-hit-slf-0.png",8);
    ...
    hitReact_sMN.AddFrame(player,0,"",folder + "/x-hit-smn-0.png",8,MISC_FLAGS.NONE,{Player:PLAYER_FLAGS.MOBILE});
    hitReact_sMN.AddFrame(player,0,"",folder + "/x-hit-smn-1.png",8);
    hitReact_sMN.AddFrame(player,0,"",folder + "/x-hit-sln-0.png",8);
    ...
    hitReact_sMF.AddFrame(player,0,"",folder + "/x-hit-smf-0.png",8,MISC_FLAGS.NONE,{Player:PLAYER_FLAGS.MOBILE});
    hitReact_sMF.AddFrame(player,0,"",folder + "/x-hit-smn-1.png",8);
    hitReact_sMF.AddFrame(player,0,"",folder + "/x-hit-sln-0.png",8);
    ...
    hitReact_sHF.AddFrameWithSound(player,1,"audio/ryu/clocked.zzz",0,"",folder + "/x-hit-shf-0.png",8,MISC_FLAGS.NONE,{Player:PLAYER_FLAGS.MOBILE});
    hitReact_sHF.AddFrame(player,0,"",folder + "/x-hit-shf-1.png",8);
    hitReact_sHF.AddFrame(player,0,"",folder + "/x-hit-slf-0.png",8);
    ...
    block.AddFrame(player,0,"",folder + "/x-block-0.png",4,{Player:PLAYER_FLAGS.BLOCKING});
    ...
    cblock.AddFrame(player,0,"",folder + "/x-crouch-block-0.png",4,{Player:PLAYER_FLAGS.BLOCKING});
    ...
    f_p2.AddRepeatingFrameWithSound(player,1,"audio/ryu/thrust-0.zzz",0,"",folder + "/x-f-p2-4.png",3,{Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MP},MISC_FLAGS.NONE,2,0,0,10,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:190,y:165}],ATTACK_FLAGS.MEDIUM,CONSTANTS.FIRST_HIT,1,10);
    f_p2.AddFrame(player,0,"",folder + "/x-f-p2-5.png",3,{Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MP},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:190,y:75},{state:HIT_FLAGS.FAR,x:160,y:145}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT,1,10);
    f_p2.AddFrame(player,0,"",folder + "/x-f-p2-6.png",3,{Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MP},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:190,y:75},{state:HIT_FLAGS.FAR,x:160,y:145}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT,1,10);
    f_p2.AddFrame(player,0,"",folder + "/x-f-p2-7.png",3,{Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MP},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:190,y:75},{state:HIT_FLAGS.FAR,x:160,y:145}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT,1,10);
    f_p2.AddFrame(player,0,"",folder + "/x-f-p2-8.png",3,{Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MP},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:190,y:75},{state:HIT_FLAGS.FAR,x:160,y:145}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT,1,10);
    f_p2.AddFrame(player,0,"",folder + "/x-f-p2-9.png",6,{Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MP},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:190,y:75},{state:HIT_FLAGS.FAR,x:160,y:145}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT,1,10);
    f_p2.EndBlock();
    ...
    p3.AddFrame(player,0,"",folder + "/x-p3-2.png",4,{SwingSound:SWINGSOUND.HP,Combat:COMBAT_FLAGS.ATTACK,Pose: POSE_FLAGS.ALLOW_INTERUPT_1,HitSound:HITSOUND.HP},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.NEAR,x:130,y:181},{state:HIT_FLAGS.FAR,x:215,y:181}],ATTACK_FLAGS.HARD,1,1,20);
    p3.EndBlock();
    ...
    throw1.AddFrame(player,0,"",folder + "/x-throw-0-4.png",26,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,-10,0,0,100,null,0,0,ATTACK_FLAGS.THROW_EJECT,[{x:-1,y:-1,Fx:0.5,Fy:0.5}],ATTACK_FLAGS.NONE,2,1,15);
    ...
    throw2.AddFrameWithSound(player,1,"audio/ryu/throw-1.zzz",0,"",folder + "/x-throw-1-2.png",5,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,-20,0,0,100,null,0,0,ATTACK_FLAGS.THROW_EJECT,[{x:-1,y:-1,Fx:1,Fy:0.5}],ATTACK_FLAGS.NONE,2,1,15);
    ...
    k2.AddFrame(player,0,"",folder + "/x-k2-2.png",7,{SwingSound:SWINGSOUND.MP,Combat:COMBAT_FLAGS.ATTACK,Pose: POSE_FLAGS.ALLOW_INTERUPT_1,HitSound:HITSOUND.MK},MISC_FLAGS.NONE,0,0,0,10,null,80,0,ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.FAR,x:200,y:135},{state:HIT_FLAGS.FAR,x:200,y:285}],ATTACK_FLAGS.MEDIUM,CONSTANTS.FIRST_HIT,1,8);
    k2.AddFrame(player,0,"",folder + "/x-k2-3.png",5,{SwingSound:SWINGSOUND.MP,Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MK},MISC_FLAGS.NONE,0,0,0,10,null,80,0,ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:200,y:135},{state:HIT_FLAGS.NEAR,x:270,y:205}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT,1,8);
    k2.EndBlock();
    ...
    fwd_k2.AddFrameWithSound(player,1,"audio/ryu/thrust-0.zzz",0,"",folder + "/x-jump-k3-4.png",4,{Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MK},MISC_FLAGS.NONE,0,-40,0,10,null,0,0,ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:180,y:135},{state:HIT_FLAGS.NEAR,x:80,y:135}],ATTACK_FLAGS.MEDIUM,1,1,10);
    fwd_k2.EndBlock();
    ...
    k3.AddFrame(player,0,"",folder + "/x-k3-2.png",4,{SwingSound:SWINGSOUND.LP,Combat:COMBAT_FLAGS.ATTACK,Pose: POSE_FLAGS.ALLOW_INTERUPT_1,HitSound:HITSOUND.HK},MISC_FLAGS.NONE,0,0,0,10,null,10,0,ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.FAR,x:180,y:235}],ATTACK_FLAGS.HARD,1,1,20);
    k3.AddFrame(player,0,"",folder + "/x-k3-3.png",6,{Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.HK},MISC_FLAGS.NONE,0,0,0,10,null,-10,0,ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.FAR,x:180,y:235}],ATTACK_FLAGS.HARD,1,1,20);
    k3.EndBlock();
    ...
    crouch_p2.AddFrame(player,0,"",folder + "/x-crouch-p2-3.png",3,{ SwingSound:SWINGSOUND.MP,Combat: COMBAT_FLAGS.ATTACK,Pose: POSE_FLAGS.ALLOW_INTERUPT_1,HitSound:HITSOUND.MK },MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.MEDIUM | ATTACK_FLAGS.HITS_LOW,[{ state: HIT_FLAGS.NEAR,x: 110,y: 120 },{ state: HIT_FLAGS.NEAR,x: 194,y: 120}],ATTACK_FLAGS.MEDIUM,1,1,15);
    crouch_p2.EndBlock();
    ...
    crouch_p3.AddFrame(player,0,"",folder + "/x-crouch-p3-2.png",3,{ SwingSound:SWINGSOUND.HP,Combat: COMBAT_FLAGS.ATTACK,Pose: POSE_FLAGS.ALLOW_INTERUPT_1,HitSound:HITSOUND.HK },MISC_FLAGS.NONE,0,0,0,25,null,0,0,ATTACK_FLAGS.HARD | ATTACK_FLAGS.HITS_LOW,[{ state: HIT_FLAGS.NEAR,x: 110,y: 120 },{ state: HIT_FLAGS.NEAR,x: 150,y: 165 },{ state: HIT_FLAGS.NEAR,x: 150,y: 220}],ATTACK_FLAGS.HARD,1,1,20);
    crouch_p3.AddFrame(player,0,"",folder + "/x-crouch-p3-3.png",6,{ Combat: COMBAT_FLAGS.ATTACK },MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HARD | ATTACK_FLAGS.HITS_LOW,[{ state: HIT_FLAGS.NEAR,x: 110,y: 120 },{ state: HIT_FLAGS.NEAR,x: 110,y: 315 },{ state: HIT_FLAGS.NEAR,x: 90,y: 315}],ATTACK_FLAGS.HARD,1,1,20);
    crouch_p3.EndBlock();
    ...
    for(var x = 0; x < 3; ++x)
    {
        ...
        var uppercut = player.AddAnimation(POSE_FLAGS.CROUCHING|POSE_FLAGS.STANDING|POSE_FLAGS.WALKING_FORWARD|POSE_FLAGS.WALKING_BACKWARD|POSE_FLAGS.ALLOW_INTERUPT_1,"uppercut p" + (x+1),50,[BUTTONS.FORWARD,0,BUTTONS.CROUCH,BUTTONS.CROUCH|BUTTONS.FORWARD,BUTTONS.CROUCH|BUTTONS.FORWARD|button],999,true,true);
    ...
    jump.AddRepeatingFrame(player,0,"",folder + "/x-jump-1.png",6,{ Pose: POSE_FLAGS.AIRBORNE,Player: PLAYER_FLAGS.SMALLER_AABB });
    jump.AddRepeatingFrame(player,0,"",folder + "/x-jump-2.png",6,{ Player: PLAYER_FLAGS.SMALLER_AABB });
    ...
    jump_p1.AddFrame(player,0,"",folder + "/x-jump-p1-2.png",24,{SwingSound:SWINGSOUND.LP,Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.LP},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.LIGHT,[{state:HIT_FLAGS.NEAR,x:160,y:75,Fx : airKnockBackX,Fy : 0}],ATTACK_FLAGS.LIGHT,1,1,10);
    jump_p1.EndBlock();
    ...
    jump_p2.AddFrame(player,0,"",folder + "/x-jump-p2-2.png",15,{SwingSound:SWINGSOUND.MP,Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MP},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:180,y:55,Fx : airKnockBackX,Fy : 0}],ATTACK_FLAGS.MEDIUM,1,1,15);
    jump_p2.EndBlock();
    ...
    f_jump_p2.AddFrame(player,0,"",folder + "/x-f-jump-p2-4.png",2,{Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MP},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:180,y:105,Fx : airKnockBackX,Fy : 0}],ATTACK_FLAGS.MEDIUM,CONSTANTS.FIRST_HIT,1,8);
    f_jump_p2.AddFrame(player,0,"",folder + "/x-f-jump-p2-5.png",12,{SwingSound:SWINGSOUND.MP,Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MP},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:160,y:225,Fx : airKnockBackX,Fy : 0},{state:HIT_FLAGS.NEAR,x:160,y:155,Fx : airKnockBackX,Fy : 0}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT,1,8);
    f_jump_p2.EndBlock();
    ...
    jump_p3.AddFrame(player,0,"",folder + "/x-jump-p2-2.png",6,{SwingSound:SWINGSOUND.HP,Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.HP},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.NEAR,x:180,y:55,Fx : airKnockBackX,Fy : 0}],ATTACK_FLAGS.HARD,1,1,20);
    jump_p3.EndBlock();
    ...
    f_jump_k2.AddFrame(player,0,"",folder + "/x-f-jump-k3-2.png",12,{SwingSound:SWINGSOUND.MP,Combat:COMBAT_FLAGS.ATTACK,HitSound:HITSOUND.MK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:230,y:0,Fx : airKnockBackX,Fy : 0},{state:HIT_FLAGS.NEAR,x:130,y:20,Fx : airKnockBackX,Fy : 0}, {state:HIT_FLAGS.NEAR,x:0,y:40,Fx : airKnockBackX,Fy : 0}],ATTACK_FLAGS.MEDIUM,1,1,15);
    f_jump_k2.EndBlock();
    ...
    f_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-2.png",12,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,-1);
    f_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-3.png",1,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,80);
    f_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-3.png",2,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,0);
    f_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-4.png",1,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,-14);
    f_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-4.png",2,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,0);
    f_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-5.png",1,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,-12,0,0,-50);
    f_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-5.png",2,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,0,0,0,-50);
    f_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-6.png",1,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,-12,0,0,0);
    f_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-6.png",5,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,0);
    f_jump.AddRepeatingFrame(player,0,"",folder + "/x-jump-1.png",1,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,-12);
    ...
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-jump-2.png",1,{Pose: POSE_FLAGS.AIRBORNE_FB},MISC_FLAGS.NONE,0,-1);
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-jump-2.png",2,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,-1);
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-6.png",1,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,0);
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-6.png",8,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,0);
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-5.png",1,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,74);
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-5.png",2,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,0);
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-4.png",1,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,-12);
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-4.png",2,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,0);
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-3.png",1,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,-12,0,0,-50);
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-3.png",2,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,0,0,0,-50);
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-2.png",1,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,-80,0,0,0);
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-f-jump-2.png",2,{Player: PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE,0,0);
    b_jump.AddRepeatingFrame(player,0,"",folder + "/x-jump-1.png",CONSTANTS.FRAME_MAX,MISC_FLAGS.NONE,MISC_FLAGS.NONE,0,0);
    ...
    for(var x = 0; x < 3; ++x)
    {
        ...
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectile-1.png",1,0,0,30);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectile-2.png",2,0,0,0);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectile-3.png",1,0,0,50);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectile-4.png",2,0,0,0);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectile-5.png",1,0,0,30);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectile-6.png",2,0,0,0);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectile-7.png",1,0,0,40);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectile-8.png",2,0,0,0);

        projectile.disintegrationAnimation_.AddFrame(player,0,"",folder + "/x-fb-projectile-hit-0.png",3,0,0,-32);
        projectile.disintegrationAnimation_.AddFrame(player,0,"",folder + "/x-fb-projectile-hit-1.png",3,0,0,-44);
        projectile.disintegrationAnimation_.AddFrame(player,0,"",folder + "/x-fb-projectile-hit-2.png",3,0,0,-20);
        projectile.disintegrationAnimation_.AddFrame(player,0,"",folder + "/x-fb-projectile-hit-3.png",3,0,0,-6);
        projectile.disintegrationAnimation_.AddFrame(player,0,"",folder + "/x-fb-projectile-hit-4.png",3,0,0,-2);
        projectile.disintegrationAnimation_.AddFrame(player,0,"",folder + "/x-fb-projectile-hit-5.png",3,0,0,0);
        ...
        fireball.AddFrame(player,0,"",folder + "/x-fb-0.png",1,MISC_FLAGS.NONE,{Player:PLAYER_FLAGS.MOBILE});
        fireball.AddFrame(player,0,"168",folder + "/x-fb-1.png",6);
        fireball.AddFrame(player,0,"200",folder + "/x-fb-2.png",2);
        fireball.AddFrameWithSound(player,1,"audio/ryu/haduken.zzz",0,"200",folder + "/x-fb-3.png",1,{Combat:COMBAT_FLAGS.SPAWN_PROJECTILE|COMBAT_FLAGS.PROJECTILE_ACTIVE|COMBAT_FLAGS.STOP_SLIDE_BACK},0,0,0,0,0,player.projectiles_.length-1);
        fireball.AddFrameWithSound(player,1,"audio/misc/projectile-0.zzz",0,"200",folder + "/x-fb-3.png",29);
    ...
    for(var x = 0; x < 3; ++x)
    {
        ...
        spinkick.AddFrameWithSound(player,1,"audio/ryu/spinkick.zzz",0,"",folder + "/x-hk-0.png",1,{Player:PLAYER_FLAGS.SMALLER_AABB,Pose:POSE_FLAGS.AIRBORNE,HitSound:HITSOUND.HK},{Player:PLAYER_FLAGS.MOBILE});
        spinkick.AddFrame(player,0,"",folder + "/x-hk-0.png",1,{Player:PLAYER_FLAGS.SMALLER_AABB},MISC_FLAGS.NONE);
        spinkick.AddFrame(player,0,"",folder + "/x-hk-1.png",3,{Player:PLAYER_FLAGS.SMALLER_AABB},0,0,70);
        spinkick.AddFrame(player,0,"",folder + "/x-hk-2.png",2,{Player:PLAYER_FLAGS.SMALLER_AABB},0,0,-20);
        ...
        spinkick.AddFrame(player,0,"",folder + "/x-hk-4.png",2,{Pose:POSE_FLAGS.HOLD_AIRBORNE,Player:PLAYER_FLAGS.SMALLER_AABB});
        ...
        spinkick.AddFrame(player,0,"",folder + "/x-hk-6.png",2,{Pose:POSE_FLAGS.HOLD_AIRBORNE,Player:PLAYER_FLAGS.SMALLER_AABB},0,0,0,0,0,null,+40);
...
Player.prototype.CreateRyuSuperMoves = function(player)
{
    ...
    for(var x = 0; x < 3; ++x)
    {
        ...
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectiles-super-1.png",1,0,0,f1);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectiles-super-2.png",2,0,0,f2);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectiles-super-3.png",1,0,0,f3);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectiles-super-4.png",2,0,0,f4);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectiles-super-5.png",1,0,0,f5);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectiles-super-6.png",2,0,0,f6);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectiles-super-7.png",1,0,0,f7);
        projectile.animation_.AddFrame(player,0,"",folder + "/x-fb-projectiles-super-8.png",2,0,0,f8);

        projectile.disintegrationAnimation_.AddFrame(player,0,"",folder + "/x-fb-projectile-hit-0.png",3,0,0,0,0);
        projectile.disintegrationAnimation_.AddFrame(player,0,"",folder + "/x-fb-projectile-hit-1.png",3,0,0,0,0);
        projectile.disintegrationAnimation_.AddFrame(player,0,"",folder + "/x-fb-projectile-hit-2.png",3,0,0,0,0);
        projectile.disintegrationAnimation_.AddFrame(player,0,"",folder + "/x-fb-projectile-hit-3.png",3,0,0,0,0);
        projectile.disintegrationAnimation_.AddFrame(player,0,"",folder + "/x-fb-projectile-hit-4.png",3,0,0,0,0);
        projectile.disintegrationAnimation_.AddFrame(player,0,"",folder + "/x-fb-projectile-hit-5.png",3,0,0,0,0);
        ...
        s_fireball.AddFrameWithSound(player,1,"audio/ryu/sinku.zzz",0,"",folder + "/x-fb-0.png",1,MISC_FLAGS.NONE,{Player:PLAYER_FLAGS.MOBILE},0,0,0,25,0,0,0,null,0,0,0,-CONSTANTS.ONE_LEVEL*(x+1));
        s_fireball.AddFrame(player,0,"",folder + "/x-fb-1.png",36,MISC_FLAGS.NONE);
        s_fireball.AddFrame(player,0,"",folder + "/x-fb-2.png",1,MISC_FLAGS.NONE,{Combat:COMBAT_FLAGS.SUPER_MOVE_PAUSE});
        s_fireball.AddFrameWithSound(player,1,"audio/ryu/haduken.zzz",0,"",folder + "/x-fb-3.png",1,{Combat:COMBAT_FLAGS.SPAWN_PROJECTILE|COMBAT_FLAGS.PROJECTILE_ACTIVE},0,0,0,0,0,player.projectiles_.length-1);
        s_fireball.AddFrameWithSound(player,1,"audio/misc/super-projectile-0.zzz",0,"",folder + "/x-fb-3.png",31);
