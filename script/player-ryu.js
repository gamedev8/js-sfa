...
Player.prototype.CreateRyu = function(right,up,left,down,p1,p2,p3,k1,k2,k3)
{
    ...
    hitReact_dead.AddFrame(player,"","images/misc/ryu/x-hit-air-0.png", 32, { Player:PLAYER_FLAGS.INVULNERABLE | PLAYER_FLAGS.IGNORE_COLLISIONS }, 0, 1);
    ...
    p1.AddFrame(player, "", "images/misc/ryu/x-p1-1.png", 3, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.LIGHT, [{ state: HIT_FLAGS.NEAR, x: 110, y: 193 }, { state: HIT_FLAGS.FAR, x: 194, y: 193}], ATTACK_FLAGS.LIGHT);
    p1.EndBlock();
    ...
    f_p2.AddRepeatingFrame(player,"","images/misc/ryu/x-f-p2-4.png",3,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,2,0,0,10,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:190,y:165}],ATTACK_FLAGS.MEDIUM,CONSTANTS.FIRST_HIT);
    f_p2.AddFrame(player,"","images/misc/ryu/x-f-p2-5.png",3,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:190,y:75},{state:HIT_FLAGS.FAR,x:160,y:145}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT);
    f_p2.AddFrame(player,"","images/misc/ryu/x-f-p2-6.png",3,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:190,y:75},{state:HIT_FLAGS.FAR,x:160,y:145}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT);
    f_p2.AddFrame(player,"","images/misc/ryu/x-f-p2-7.png",3,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:190,y:75},{state:HIT_FLAGS.FAR,x:160,y:145}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT);
    f_p2.AddFrame(player,"","images/misc/ryu/x-f-p2-8.png",3,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:190,y:75},{state:HIT_FLAGS.FAR,x:160,y:145}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT);
    f_p2.AddFrame(player,"","images/misc/ryu/x-f-p2-9.png",6,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:190,y:75},{state:HIT_FLAGS.FAR,x:160,y:145}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT);
    f_p2.EndBlock();
    ...
    p3.AddFrame(player,"","images/misc/ryu/x-p3-2.png",4,{Combat:COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.NEAR,x:130,y:181},{state:HIT_FLAGS.FAR,x:215,y:181}],ATTACK_FLAGS.HARD);
    p3.EndBlock();
    ...
    throw1.AddFrame(player,"","images/misc/ryu/x-throw-0-4.png",26,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,-10,0,0,100,null,0,0,ATTACK_FLAGS.THROW_EJECT,[{x:-1,y:-1,Fx:0.5,Fy:0.5}],ATTACK_FLAGS.NONE,2);
    ...
    throw2.AddFrame(player,"","images/misc/ryu/x-throw-1-2.png",5,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,-20,0,0,100,null,0,0,ATTACK_FLAGS.THROW_EJECT,[{x:-1,y:-1,Fx:1,Fy:0.5}],ATTACK_FLAGS.NONE,2);
    ...
    k1.AddFrame(player, "", "images/misc/ryu/x-k1-2.png", 7, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 80, 0, ATTACK_FLAGS.LIGHT, [{ state: HIT_FLAGS.NEAR, x: 200, y: 135 }, { state: HIT_FLAGS.NEAR, x: 250, y: 85}], ATTACK_FLAGS.LIGHT);
    k1.EndBlock();
    k1.AddFrame(player, "", "images/misc/ryu/x-k1-1.png", 2, MISC_FLAGS.NONE, MISC_FLAGS.NONE, 0, 0, 0, 0, 0, 60);
    ...
    k2.AddFrame(player,"","images/misc/ryu/x-k2-2.png",7,{Combat:COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT},MISC_FLAGS.NONE,0,0,0,10,null,80,0,ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.FAR,x:200,y:135},{state:HIT_FLAGS.FAR,x:200,y:285}],ATTACK_FLAGS.MEDIUM,CONSTANTS.FIRST_HIT);
    k2.AddFrame(player,"","images/misc/ryu/x-k2-3.png",5,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,80,0,ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:200,y:135},{state:HIT_FLAGS.NEAR,x:270,y:205}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT);
    k2.EndBlock();
    ...
    fwd_k2.AddFrame(player,"","images/misc/ryu/x-jump-k3-4.png",4,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,-40,0,10,null,0,0,ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:180,y:135},{state:HIT_FLAGS.NEAR,x:80,y:135}],ATTACK_FLAGS.MEDIUM);
    fwd_k2.EndBlock();
    ...
    k3.AddFrame(player,"","images/misc/ryu/x-k3-2.png",4,{Combat:COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT},MISC_FLAGS.NONE,0,0,0,10,null,10,0,ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.FAR,x:180,y:235}],ATTACK_FLAGS.HARD);
    ...
    crouch_p1.AddFrame(player, "", "images/misc/ryu/x-crouch-p1-2.png", 3, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.LIGHT | ATTACK_FLAGS.HITS_LOW, [{ state: HIT_FLAGS.NEAR, x: 110, y: 120 }, { state: HIT_FLAGS.NEAR, x: 194, y: 120}], ATTACK_FLAGS.LIGHT);
    crouch_p1.EndBlock();
    ...
    crouch_p2.AddFrame(player, "", "images/misc/ryu/x-crouch-p2-3.png", 3, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.MEDIUM | ATTACK_FLAGS.HITS_LOW, [{ state: HIT_FLAGS.NEAR, x: 110, y: 120 }, { state: HIT_FLAGS.NEAR, x: 194, y: 120}], ATTACK_FLAGS.MEDIUM);
    crouch_p2.EndBlock();
    ...
    crouch_p3.AddFrame(player, "", "images/misc/ryu/x-crouch-p3-2.png", 3, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 25, null, 0, 0, ATTACK_FLAGS.HARD | ATTACK_FLAGS.HITS_LOW, [{ state: HIT_FLAGS.NEAR, x: 110, y: 120 }, { state: HIT_FLAGS.NEAR, x: 150, y: 165 }, { state: HIT_FLAGS.NEAR, x: 150, y: 220}], ATTACK_FLAGS.HARD);
    crouch_p3.AddFrame(player, "", "images/misc/ryu/x-crouch-p3-3.png", 6, { Combat: COMBAT_FLAGS.ATTACK }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.HARD | ATTACK_FLAGS.HITS_LOW, [{ state: HIT_FLAGS.NEAR, x: 110, y: 120 }, { state: HIT_FLAGS.NEAR, x: 110, y: 315 }, { state: HIT_FLAGS.NEAR, x: 90, y: 315}], ATTACK_FLAGS.HARD);
    crouch_p3.EndBlock();
    ...
    crouch_k1.AddFrame(player, "", "images/misc/ryu/x-crouch-k1-2.png", 5, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.LIGHT | ATTACK_FLAGS.HITS_LOW, [{ state: HIT_FLAGS.NEAR, x: 110, y: 40 }, { state: HIT_FLAGS.NEAR, x: 210, y: 1}], ATTACK_FLAGS.LIGHT);
    crouch_k1.EndBlock();
    ...
    crouch_k2.AddFrame(player, "264", "images/misc/ryu/x-crouch-k2-3.png", 5, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.MEDIUM | ATTACK_FLAGS.HITS_LOW, [{ state: HIT_FLAGS.NEAR, x: 140, y: 35 }, { state: HIT_FLAGS.NEAR, x: 185, y: 30 }, { state: HIT_FLAGS.NEAR, x: 260, y: 1}], ATTACK_FLAGS.MEDIUM);
    crouch_k2.EndBlock();
    ...
    var crouch_k3 = player.AddAnimation(POSE_FLAGS.CROUCHING|POSE_FLAGS.STANDING, "crouch k3", 0, [BUTTONS.CROUCH|BUTTONS.HARD_KICK], 110);
    ...
    crouch_k3.AddFrame(player, "", "images/misc/ryu/x-crouch-k3-2.png", 5, { Combat: COMBAT_FLAGS.ATTACK, Pose: POSE_FLAGS.ALLOW_INTERUPT }, MISC_FLAGS.NONE, 0, 0, 0, 10, null, 0, 0, ATTACK_FLAGS.HARD | ATTACK_FLAGS.HITS_LOW | ATTACK_FLAGS.TRIP, [{ state: HIT_FLAGS.NEAR, x: 160, y: 35 }, { state: HIT_FLAGS.FAR, x: 250, y: 35}], ATTACK_FLAGS.HARD);
    crouch_k3.EndBlock();
    ...
    for(var x = 0; x < 3; ++x)
    {
        ...
        var uppercut = player.AddAnimation(POSE_FLAGS.CROUCHING|POSE_FLAGS.STANDING|POSE_FLAGS.WALKING_FORWARD|POSE_FLAGS.WALKING_BACKWARD|POSE_FLAGS.ALLOW_INTERUPT,"uppercut p" + (x+1),200,[BUTTONS.FORWARD,0,BUTTONS.CROUCH,BUTTONS.CROUCH|BUTTONS.FORWARD,BUTTONS.FORWARD|button],999,true,true);
    ...
    jump_p1.AddFrame(player,"","images/misc/ryu/x-jump-p1-2.png",24,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.LIGHT,[{state:HIT_FLAGS.NEAR,x:160,y:75, Fx : airKnockBackX, Fy : 0}],ATTACK_FLAGS.LIGHT);
    jump_p1.EndBlock();
    ...
    jump_p2.AddFrame(player,"","images/misc/ryu/x-jump-p2-2.png",15,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:180,y:55, Fx : airKnockBackX, Fy : 0}],ATTACK_FLAGS.MEDIUM);
    jump_p2.EndBlock();
    ...
    f_jump_p2.AddFrame(player,"","images/misc/ryu/x-f-jump-p2-4.png",2,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:180,y:105, Fx : airKnockBackX, Fy : 0}],ATTACK_FLAGS.MEDIUM,CONSTANTS.FIRST_HIT);
    f_jump_p2.AddFrame(player,"","images/misc/ryu/x-f-jump-p2-5.png",12,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:160,y:225, Fx : airKnockBackX, Fy : 0},{state:HIT_FLAGS.NEAR,x:160,y:155, Fx : airKnockBackX, Fy : 0}],ATTACK_FLAGS.MEDIUM,CONSTANTS.SECOND_HIT);
    f_jump_p2.EndBlock();
    ...
    jump_p3.AddFrame(player,"","images/misc/ryu/x-jump-p2-2.png",6,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.NEAR,x:180,y:55, Fx : airKnockBackX, Fy : 0}],ATTACK_FLAGS.HARD);
    jump_p3.EndBlock();
    ...
    jump_k1.AddFrame(player,"","images/misc/ryu/x-jump-k1-2.png",24,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.LIGHT,[{state:HIT_FLAGS.NEAR,x:140,y:235, Fx : airKnockBackX, Fy : 0},{state:HIT_FLAGS.NEAR,x:90,y:155, Fx : airKnockBackX, Fy : 0}],ATTACK_FLAGS.LIGHT);
    jump_k1.EndBlock();
    ...
    jump_k2.AddFrame(player,"","images/misc/ryu/x-jump-k1-2.png",4,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:140,y:235, Fx : airKnockBackX, Fy : 0},{state:HIT_FLAGS.NEAR,x:90,y:155, Fx : airKnockBackX, Fy : 0}],ATTACK_FLAGS.MEDIUM);
    jump_k2.EndBlock();
    ...
    jump_k3.AddFrame(player,"","images/misc/ryu/x-jump-k3-4.png",6,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.NEAR,x:180,y:135, Fx : airKnockBackX, Fy : 0},{state:HIT_FLAGS.NEAR,x:80,y:135, Fx : airKnockBackX, Fy : 0}],ATTACK_FLAGS.HARD);
    jump_k3.EndBlock();
    ...
    f_jump_k1.AddFrame(player,"","images/misc/ryu/x-f-jump-k1-3.png",CONSTANTS.FRAME_MAX,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.LIGHT,[{state:HIT_FLAGS.NEAR,x:140,y:15, Fx : airKnockBackX, Fy : 0},{state:HIT_FLAGS.NEAR,x:100,y:0, Fx : airKnockBackX, Fy : 0}],ATTACK_FLAGS.LIGHT);
    f_jump_k1.EndBlock();
    ...
    f_jump_k2.AddFrame(player,"","images/misc/ryu/x-f-jump-k3-2.png",12,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.MEDIUM,[{state:HIT_FLAGS.NEAR,x:230,y:0, Fx : airKnockBackX, Fy : 0},{state:HIT_FLAGS.NEAR,x:130,y:20, Fx : airKnockBackX, Fy : 0}],ATTACK_FLAGS.MEDIUM);
    f_jump_k2.EndBlock();
    ...
    f_jump_k3.AddFrame(player,"","images/misc/ryu/x-f-jump-k3-2.png",6,{Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,10,null,0,0,ATTACK_FLAGS.HITS_HIGH|ATTACK_FLAGS.HARD,[{state:HIT_FLAGS.NEAR,x:230,y:0, Fx : airKnockBackX, Fy : 0},{state:HIT_FLAGS.NEAR,x:130,y:20, Fx : airKnockBackX, Fy : 0}],ATTACK_FLAGS.HARD);
    f_jump_k3.EndBlock();
    ...
    for(var x = 0; x < 3; ++x)
    {
        ...
        var fireball = player.AddAnimation(POSE_FLAGS.STANDING|POSE_FLAGS.CROUCHING|POSE_FLAGS.WALKING_BACKWARD|POSE_FLAGS.WALKING_FORWARD|POSE_FLAGS.ALLOW_INTERUPT,"fireball p" + (x+1),50,[BUTTONS.CROUCH, BUTTONS.CROUCH|BUTTONS.FORWARD, BUTTONS.FORWARD, BUTTONS.FORWARD|button],0,false);
    ...
    for(var x = 0; x < 3; ++x)
    {
        ...
        var spinkick = player.AddAnimation(POSE_FLAGS.AIRBORNE|POSE_FLAGS.AIRBORNE_FB|POSE_FLAGS.STANDING|POSE_FLAGS.CROUCHING|POSE_FLAGS.WALKING_BACKWARD|POSE_FLAGS.WALKING_FORWARD|POSE_FLAGS.ALLOW_INTERUPT,"spinkick k" + (x+1),100,[BUTTONS.CROUCH, BUTTONS.CROUCH|BUTTONS.BACK,BUTTONS.BACK, BUTTONS.BACK|button],0,true,true);
        ...
        for(var i = 0; i < (1 + x); ++i)
        {
            spinkick.AddFrame(player,"","images/misc/ryu/x-hk-3.png",2,{Pose:POSE_FLAGS.HOLD_AIRBORNE, Player:PLAYER_FLAGS.SMALLER_AABB,Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,baseDamage,null,40,0,ATTACK_FLAGS.SPECIAL|ATTACK_FLAGS.HARD|ATTACK_FLAGS.TRIP,[{state:HIT_FLAGS.NEAR, x:230, y:97 }, { state:HIT_FLAGS.NEAR, x:140, y:97},{state:HIT_FLAGS.NEAR,x:230,y:127},{state:HIT_FLAGS.NEAR,x:140,y:127}],rearFlags,CONSTANTS.FIRST_HIT,CONSTANTS.SINGLE);
            spinkick.AddFrame(player,"","images/misc/ryu/x-hk-4.png",2,{Pose:POSE_FLAGS.HOLD_AIRBORNE, Player:PLAYER_FLAGS.SMALLER_AABB});
            spinkick.AddFrame(player,"","images/misc/ryu/x-hk-5.png",2,{Pose:POSE_FLAGS.HOLD_AIRBORNE, Player:PLAYER_FLAGS.SMALLER_AABB,Combat:COMBAT_FLAGS.ATTACK},MISC_FLAGS.NONE,0,0,0,baseDamage,null,-30,0,ATTACK_FLAGS.SPECIAL|ATTACK_FLAGS.HARD|ATTACK_FLAGS.TRIP,[{state:HIT_FLAGS.NEAR, x:-30, y:97 }, { state:HIT_FLAGS.NEAR, x:30, y:97},{state:HIT_FLAGS.NEAR,x:-30,y:127},{state:HIT_FLAGS.NEAR,x:30,y:127}],rearFlags,CONSTANTS.FIRST_HIT,CONSTANTS.SINGLE);
            spinkick.AddFrame(player,"","images/misc/ryu/x-hk-6.png",2,{Pose:POSE_FLAGS.HOLD_AIRBORNE, Player:PLAYER_FLAGS.SMALLER_AABB},0,0,0,0,0,null,+40);
        }
...
Player.prototype.CreateRyuSuperMoves = function(player)
{
    ...
    for(var x = 0; x < 3; ++x)
    {
        ...
        var s_fireball = player.AddAnimation(POSE_FLAGS.STANDING|POSE_FLAGS.CROUCHING|POSE_FLAGS.WALKING_BACKWARD|POSE_FLAGS.WALKING_FORWARD|POSE_FLAGS.ALLOW_INTERUPT,"super fireball p" + (x+1),50,[BUTTONS.CROUCH, BUTTONS.CROUCH|BUTTONS.FORWARD, BUTTONS.FORWARD,0,BUTTONS.CROUCH, BUTTONS.CROUCH|BUTTONS.FORWARD, BUTTONS.FORWARD, BUTTONS.FORWARD|button],CONSTANTS.MAX_PRIORITY,false);
