...
Player.prototype.createAkuma = function(user)
{
    ...
    getup.addFrame(player,0,"",folder + "/crouch-0.png",4,{Player:PLAYER_FLAGS.INVULNERABLE|PLAYER_FLAGS.MOBILE});
    ...
    for(var x = 0; x < 3; ++x)
    {
        ...
        if(x == 0)
        {
            uppercut.addFrame(player,0,"",folder + "/x-uppercut-p1-1.png",2,{Juggle:JUGGLE_FLAGS.ALIVE,Combat:COMBAT_FLAGS.ATTACK,Player:PLAYER_FLAGS.IGNORE_PROJECTILES,HitSound:HITSOUND.HP3});
            uppercut.addFrameWithSound(player,1,"audio/akuma/thrust-1.zzz",0,"",folder + "/x-uppercut-p1-2.png",3,{HitReact:HIT_REACT.EJECT,Combat:COMBAT_FLAGS.ATTACK,Player:PLAYER_FLAGS.IGNORE_PROJECTILES,HitSound:HITSOUND.HP3},MISC_FLAGS.NONE,0,0,0,75,null,0,0,ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD | ATTACK_FLAGS.KNOCKDOWN,[{state:HIT_FLAGS.LOW,x:170,y:177}],ATTACK_FLAGS.HARD|ATTACK_FLAGS.REAR|ATTACK_FLAGS.SPECIAL2,CONSTANTS.FIRST_HIT,CONSTANTS.SINGLE,25);
            uppercut.addFrame(player,0,"",folder + "/x-uppercut-p1-3.png",1,{HitReact:HIT_REACT.EJECT,Juggle:JUGGLE_FLAGS.ALIVE,Combat:COMBAT_FLAGS.ATTACK,Player:PLAYER_FLAGS.IGNORE_PROJECTILES,Pose:POSE_FLAGS.AIRBORNE,HitSound:HITSOUND.HP3},MISC_FLAGS.NONE,0,0,0,75,null,0,0,ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD | ATTACK_FLAGS.KNOCKDOWN,[{state:HIT_FLAGS.HIGH,x:130,y:127},{state:HIT_FLAGS.HIGH,x:110,y:227},{state:HIT_FLAGS.HIGH,x:100,y:322}],ATTACK_FLAGS.HARD|ATTACK_FLAGS.REAR|ATTACK_FLAGS.SPECIAL3,CONSTANTS.FIRST_HIT,CONSTANTS.SINGLE);
            uppercut.addFrame(player,0,"",folder + "/x-uppercut-p1-3.png",10,{HitReact:HIT_REACT.EJECT,Juggle:JUGGLE_FLAGS.ALIVE,Combat:COMBAT_FLAGS.ATTACK,Player:PLAYER_FLAGS.IGNORE_PROJECTILES,HitSound:HITSOUND.HP3},MISC_FLAGS.NONE,0,0,0,75,null,0,0,ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD | ATTACK_FLAGS.KNOCKDOWN,[{state:HIT_FLAGS.HIGH,x:130,y:127},{state:HIT_FLAGS.HIGH,x:110,y:227},{state:HIT_FLAGS.HIGH,x:100,y:322}],ATTACK_FLAGS.HARD|ATTACK_FLAGS.REAR|ATTACK_FLAGS.SPECIAL3,CONSTANTS.FIRST_HIT,CONSTANTS.SINGLE);
        }
        else if(x == 1)
        {
            uppercut.addFrame(player,0,"",folder + "/x-uppercut-p1-1.png",2,{Juggle:JUGGLE_FLAGS.ALIVE,Combat:COMBAT_FLAGS.ATTACK,Player:PLAYER_FLAGS.IGNORE_PROJECTILES,HitSound:HITSOUND.HP3});
            uppercut.addFrameWithSound(player,1,"audio/akuma/thrust-1.zzz",0,"",folder + "/x-uppercut-p1-2.png",3,{HitReact:HIT_REACT.AIRBORNE_EJECT,Combat:COMBAT_FLAGS.ATTACK,Player:PLAYER_FLAGS.IGNORE_PROJECTILES,HitSound:HITSOUND.HP3},MISC_FLAGS.NONE,0,0,0,35,null,0,0,ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD | ATTACK_FLAGS.FLOOR_AIRBORNE,[{state:HIT_FLAGS.LOW,x:170,y:177}],ATTACK_FLAGS.HARD|ATTACK_FLAGS.REAR|ATTACK_FLAGS.SPECIAL2,CONSTANTS.FIRST_HIT,CONSTANTS.SINGLE,25);
            uppercut.addFrame(player,0,"",folder + "/x-uppercut-p1-3.png",1,{HitReact:HIT_REACT.EJECT,Juggle:JUGGLE_FLAGS.ALIVE,Combat:COMBAT_FLAGS.ATTACK,Player:PLAYER_FLAGS.IGNORE_PROJECTILES,Pose:POSE_FLAGS.AIRBORNE,HitSound:HITSOUND.HP3},MISC_FLAGS.NONE,0,0,0,35,null,0,0,ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD | ATTACK_FLAGS.KNOCKDOWN,[{state:HIT_FLAGS.HIGH,x:130,y:127},{state:HIT_FLAGS.HIGH,x:110,y:227},{state:HIT_FLAGS.HIGH,x:100,y:322}],ATTACK_FLAGS.HARD|ATTACK_FLAGS.REAR|ATTACK_FLAGS.SPECIAL3,CONSTANTS.SECOND_HIT,CONSTANTS.SINGLE);
            uppercut.addFrame(player,0,"",folder + "/x-uppercut-p1-3.png",14,{HitReact:HIT_REACT.EJECT,Juggle:JUGGLE_FLAGS.ALIVE,Combat:COMBAT_FLAGS.ATTACK,Player:PLAYER_FLAGS.IGNORE_PROJECTILES,HitSound:HITSOUND.HP3},MISC_FLAGS.NONE,0,0,0,35,null,0,0,ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD | ATTACK_FLAGS.KNOCKDOWN,[{state:HIT_FLAGS.HIGH,x:130,y:127},{state:HIT_FLAGS.HIGH,x:110,y:227},{state:HIT_FLAGS.HIGH,x:100,y:322}],ATTACK_FLAGS.HARD|ATTACK_FLAGS.REAR|ATTACK_FLAGS.SPECIAL3,CONSTANTS.SECOND_HIT,CONSTANTS.SINGLE);
        }
        else if(x == 2)
        {
            uppercut.addFrame(player,0,"",folder + "/x-uppercut-p1-1.png",2,{HitReact:HIT_REACT.AIRBORNE_EJECT,Juggle:JUGGLE_FLAGS.ALIVE,Combat:COMBAT_FLAGS.ATTACK,Player:PLAYER_FLAGS.IGNORE_PROJECTILES,HitSound:HITSOUND.HP3},MISC_FLAGS.NONE,0,0,0,40,null,0,0,ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD | ATTACK_FLAGS.FLOOR_AIRBORNE,[{state:HIT_FLAGS.LOW,x:120,y:127}],ATTACK_FLAGS.HARD|ATTACK_FLAGS.REAR|ATTACK_FLAGS.SPECIAL2,CONSTANTS.FIRST_HIT,CONSTANTS.SINGLE,25);
            ...
            uppercut.addFrame(player,0,"",folder + "/x-uppercut-p1-3.png",1,{HitReact:HIT_REACT.EJECT,Juggle:JUGGLE_FLAGS.ALIVE,Combat:COMBAT_FLAGS.ATTACK,Player:PLAYER_FLAGS.IGNORE_PROJECTILES,Pose:POSE_FLAGS.AIRBORNE,HitSound:HITSOUND.HP3},MISC_FLAGS.NONE,0,0,0,40,null,0,0,ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD | ATTACK_FLAGS.KNOCKDOWN,[{state:HIT_FLAGS.HIGH,x:130,y:127},{state:HIT_FLAGS.HIGH,x:110,y:227},{state:HIT_FLAGS.HIGH,x:100,y:322}],ATTACK_FLAGS.HARD|ATTACK_FLAGS.REAR|ATTACK_FLAGS.SPECIAL3,CONSTANTS.THIRD_HIT,CONSTANTS.SINGLE);
            uppercut.addFrame(player,0,"",folder + "/x-uppercut-p1-3.png",18,{HitReact:HIT_REACT.EJECT,Juggle:JUGGLE_FLAGS.ALIVE,Combat:COMBAT_FLAGS.ATTACK,Player:PLAYER_FLAGS.IGNORE_PROJECTILES,HitSound:HITSOUND.HP3},MISC_FLAGS.NONE,0,0,0,40,null,0,0,ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD | ATTACK_FLAGS.KNOCKDOWN,[{state:HIT_FLAGS.HIGH,x:130,y:127},{state:HIT_FLAGS.HIGH,x:110,y:227},{state:HIT_FLAGS.HIGH,x:100,y:322}],ATTACK_FLAGS.HARD|ATTACK_FLAGS.REAR|ATTACK_FLAGS.SPECIAL3,CONSTANTS.THIRD_HIT,CONSTANTS.SINGLE);
        }
        uppercut.endBlock();
    ...
    this.createAkumaSuperFireball(player);
    this.createAkumaSuperAirFireball(player);
    this.createAkumaSuperUppercut(player);
...
Player.prototype.createAkumaSuperUppercut = function(player)
{
    var folder = "images/misc/" + player.Folder;
    var uppercutVelocityY = 120;
    var uppercutVelocityYRate = 50;
    ...
    for(var x = 0; x < 3; ++x)
    {
        ...
        s_uppercut.addRepeatingFrame(player,0,"",folder + "/x-uppercut-p1-1.png",3,{HitReact:HIT_REACT.AIRBORNE_EJECT,Juggle:JUGGLE_FLAGS.ALIVE,Combat:COMBAT_FLAGS.ATTACK,Player:PLAYER_FLAGS.IGNORE_PROJECTILES,HitSound:HITSOUND.HP3},MISC_FLAGS.NONE,10,0,0,40,0,0,ATTACK_FLAGS.SPECIAL | ATTACK_FLAGS.HARD | ATTACK_FLAGS.FLOOR_AIRBORNE,[{state:HIT_FLAGS.LOW,x:120,y:127}],ATTACK_FLAGS.HARD|ATTACK_FLAGS.REAR|ATTACK_FLAGS.SPECIAL2,combo++,CONSTANTS.SINGLE,25).hitStop(2,6);
...
Player.prototype.createAkumaSuperFireball = function(player)
{
    var folder = "images/misc/" + player.Folder;
...
Player.prototype.createAkumaSuperAirFireball = function(player)
{
    var folder = "images/misc/" + player.Folder;
